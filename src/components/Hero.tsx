    ...
    <section className="relative h-screen overflow-hidden hero ">
      ...
      <div className="relative h-full max-w-[1800px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="relative h-full flex flex-col justify-center items-center">
          ...
          <div className="absolute top-12 left-0 right-0 z-30 flex items-center justify-between px-6 md:px-12">
            <div className={`inline-flex items-center gap-3 px-5 py-2 rounded-full border backdrop-blur-xl transition-all duration-300 ${
              isDarkMode 
            ...
            <div className={`hidden md:flex items-baseline gap-3 px-6 py-3 rounded-full border backdrop-blur-xl ${
              isDarkMode 
                ? 'bg-[#1A1612]/60 border-[#C9A882]/20' 
                : 'bg-white/60 border-gray-200/60'
            }`}>
              <span className={`text-xs tracking-[0.2em] uppercase ${
                isDarkMode ? 'text-[#A89178]' : 'text-gray-600'
              }`}>From</span>
              <span className={`text-2xl tracking-tight ${
                isDarkMode ? 'text-[#F5EDE3]' : 'text-gray-900'
              }`}>₹1,299</span>
            </div>
          </div>
          ...
          <div className="relative w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center py-20 lg:py-0">
            ...
            <div className="lg:col-span-3 order-2 lg:order-1 space-y-8">
              <div className="space-y-6">
                <div className={`h-px w-16 ${
                  isDarkMode ? 'bg-[#C9A882]/30' : 'bg-gray-300'
                }`}></div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  >
                    <div className={`mt-1 p-3 rounded-xl border transition-all duration-300 group-hover:scale-110 group-hover:border-[#C9A882]/50 ${
                      isDarkMode 
                        ? 'bg-[#1A1612]/60 border-[#C9A882]/20' 
                        : 'bg-white/60 border-gray-200/60'
                    }`}>
                    ...
                    <div className="flex-1">
                      <div className={`text-sm mb-1 transition-colors duration-300 ${
                        isDarkMode ? 'text-[#F5EDE3] group-hover:text-[#C9A882]' : 'text-gray-900 group-hover:text-[#C9A882]'
                      }`}>
                        {item.title}
                      </div>
            ...
            <div className="lg:col-span-6 order-1 lg:order-2 relative">
              ...
              <div className="text-center mb-8 lg:mb-12">
                <h1 className="space-y-2">
                  <div className={`text-7xl md:text-8xl xl:text-9xl tracking-[-0.04em] leading-[0.85] ${
                    isDarkMode ? 'text-[#F5EDE3]' : 'text-[#1A1A1A]'
                  }`}>
                    IORA
                  </div>
                  <div className="flex items-center justify-center gap-3">
                    <span className={`text-4xl md:text-5xl xl:text-6xl tracking-wide ${
                      isDarkMode ? 'text-[#4A4137]' : 'text-gray-400'
                    }`}>—</span>
              ...
              <div className="relative w-full max-w-lg mx-auto">
                ...
                {/* Glow */}
                <div className="absolute inset-0 flex items-center justify-center -z-10">
                  <div className={`w-3/4 h-3/4 rounded-full blur-[140px] ${
                    isDarkMode ? 'bg-[#C9A882]/35' : 'bg-[#C9A882]/25'
                  }`}></div>
                </div>
                ...
                <div className="relative group p-8 md:p-12">
                  ...
                  {/* Floating badge */}
                  <div className={`absolute top-0 right-0 w-24 h-24 rounded-full flex flex-col items-center justify-center backdrop-blur-xl border shadow-2xl transition-all duration-300 group-hover:scale-110 ${
                    isDarkMode 
              ...
              <div className="text-center mt-8 max-w-xl mx-auto">
                <p className={`text-base md:text-lg leading-[1.8] ${
                  isDarkMode ? 'text-[#D4C4B0]' : 'text-gray-600'
                }`}>
            ...
            <div className="lg:col-span-3 order-3 space-y-8">
              ...
              <div className="space-y-3">
                ...
                <button 
                  className={`w-full group px-8 py-5 border-2 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus:ring-4 ${
                    isDarkMode 
              ...
              <div className="space-y-4">
                <div className={`p-5 rounded-2xl border backdrop-blur-md transition-all duration-300 ${
                  ...
                  <div className={`text-xs tracking-wider uppercase mb-2 ${
                    isDarkMode ? 'text-[#A89178]' : 'text-gray-600'
                  }`}>Size</div>
                ...
                <div className={`p-5 rounded-2xl border backdrop-blur-md transition-all duration-300 ${
                  ...
                  <div className={`text-sm ${
                    isDarkMode ? 'text-[#D4C4B0]' : 'text-gray-700'
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 hidden lg:flex flex-col items-center gap-3 animate-bounce">
        ...
        <div className={`w-px h-12 ${
          isDarkMode ? 'bg-gradient-to-b from-gray-600 to-transparent' : 'bg-gradient-to-b from-gray-400 to-transparent'
        }`}></div>
      </div>
    </section>
  );
